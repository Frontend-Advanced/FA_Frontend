...
export default function RegisterForm () {
	...
	return (
		<div className="pt-12">
			...
			<p className="text-3xl text-[#004715] font-semibold mb-10">Unlock exclusive access.</p>
			<form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
				...
				<div className="space-y-2">
					...
					<div className="relative">
						...
						<button type="button" onClick={() => setShowPassword(!showPassword)} className="text-secondary absolute right-2 top-1/2 transform -translate-y-1/2">
				...
				<div className="space-y-2">
					...
					<div className="relative">
						...
						<button type="button" onClick={() => setShowConfirmPassword(!showConfirmPassword)} className="text-secondary absolute right-2 top-1/2 transform -translate-y-1/2">
